...
<!-- navbar abajo -->
	...
	int id = (Integer.parseInt(request.getSession().getAttribute("idClientModify").toString()));
	Client c = new Client();
	c = cdao.searchById(id);
	
	%>
 <!-- Formulario a continuacion -->
	<form action="clientmodify" method="POST" name="addclient"
		class="was-validated">
		<div class="row">
			<div class="col">
			...
			<div class="col">
				<input type="text" name="transport" class="form-control"
					value = <%='"' + c.getTransport() + '"'%>>
			</div>
			<br>
			<br>
				<button type="submit" name = "accion" value="modifyclientexecute" class="btn btn-primary btn-lg btn-block">MODIFICAR
					CLIENTE</button>
