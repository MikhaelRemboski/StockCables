...
<body>
	...
	<form action="stockadded" method="POST" name="addStock"
		class="was-validated">
		<div class="row">
			<div class="col">
			...
			<div class="col">
				<input type="text" name="metersbytype" class="form-control"
					placeholder="Metros por tipo">
			</div>
			<div class="col">
				<input type="text" name="unitys" class="form-control"
					placeholder="Cantidad de unidades del tipo">
			</div>
			<div class="col">
		...
		<div class="form-check form-check-inline">
			<input class="form-check-input" type="radio" name="type"
				id="inlineRadio1" value="bobina"> <label
				class="form-check-label" for="inlineRadio1">Bobina</label>
		</div>
		<div class="form-check form-check-inline">
			<input class="form-check-input" type="radio" name="type"
				id="inlineRadio2" value="rollo"> <label
				class="form-check-label" for="inlineRadio2">Rollo</label>
		</div>
